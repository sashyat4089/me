...
import Project from "./skill/project1.png"
import Ach from "./skill/ach1.jpg"
import contact from "./skill/contact.jpg"
import mob from "./skill/1.png"
import email from "./skill/2.webp"
      ...
      <div id="CONTACT" className="aboutimage"   >
        ...
        <div className="education" >
          ...
          <div>
            <div className="edudetail">
              <h1> <b>
                <img src={mob} width="50" alt="dm"></img>    +917320869235
              </b></h1>
              <h1><b> <img src={email} width="50" alt="dm" ></img>
                sashyat_11814089@nitkkr.ac.in
              </b></h1>
              <h1><img src={linkdin} width="50" alt="dm"></img> https://www.linkedin.com/in/sashyat-singh-789797204</h1>
              <h1><b>
                <img src={git} width="50" alt="dm"></img>
